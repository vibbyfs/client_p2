...
const featuresDetail = [
  ...
  },
  {
    ...
    quote: <Sparkles className="h-10 w-10" aria-hidden />,
    title: "Template pesan humanis yang bisa diatur sesuai kepribadian.",
  },
  {
    name: "Pintar Zona Waktu",
    quote: <Clock className="h-10 w-10" aria-hidden />,
